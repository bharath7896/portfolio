...
//				console.log(data.responseText.substring(18, data.responseText.length - 1));
	...
	var _commands = {
		...
		'who created you': _writeWrapper("necessity"),
	...
	var start = function () {
		if (annyang) {
			setTimeout(function () {
				...
				samaritanModule.write(" I am SAMARITAN BHARADWAJ's Personal Assistant ");
			}, 12000);
